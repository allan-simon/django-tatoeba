...
DATABASES = {
    'default': {
        ...
        'NAME': 'tatoeba',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '9y3kp6*&84n%@m7)zq*4mt@b$uit!+y=#kpkb0+#96@&c3@809'
...
ROOT_URLCONF = 'tatoeba.urls'

TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/Users/biptaste/Documents/tatoeba/tatoeba/templates',
)
